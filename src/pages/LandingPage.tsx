  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 sm:py-20 md:py-32 relative">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-heading font-extrabold text-foreground leading-tight mb-4 sm:mb-6">
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {features.map((f) => (
              <div key={f.title} className="bg-card rounded-xl p-4 sm:p-6 border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg wallet-gradient flex items-center justify-center mb-3 sm:mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="w-full max-w-sm">
                <div className="wallet-gradient rounded-2xl p-5 sm:p-6 text-primary-foreground">
